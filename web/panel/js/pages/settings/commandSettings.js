...
$(run = function() {
    ...
    socket.getDBValues('get_command_settings', {
        ...
        // Set cost message.
        $('#cmd-cost-messages').val((e.priceComMsgEnabled === 'true' ? 'Включить' : 'Выключить'));
        // Set permission message.
        $('#cmd-perm-messages').val((e.permComMsgEnabled === 'true' ? 'Включить' : 'Выключить'));
        // Set cooldown message.
        $('#cmd-cooldown-messages').val((e.coolDownMsgEnabled === 'true' ? 'Включить' : 'Выключить'));
        // Set cost for mods.
